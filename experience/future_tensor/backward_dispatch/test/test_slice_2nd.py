...
Run:
    python -m experience.future_tensor.backward_dispatch.test.test_slice_2nd
"""
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    run_test("backward_dispatch_start.grad is scalar",
             backward_dispatch_start.grad.shape == torch.Size([]))
